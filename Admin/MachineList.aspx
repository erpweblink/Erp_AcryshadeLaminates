                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="GVCompany" runat="server" DataKeyNames="ID" OnRowDataBound="GVCompany_RowDataBound" CssClass="table table-bordered table-striped" HeaderStyle-BackColor="#5b78b1"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Running Hours" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Activate Date" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:Label ID="lblIsActivateDate" runat="server" Text='<%#Eval("IsActivateDate")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Deactivate Date" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
