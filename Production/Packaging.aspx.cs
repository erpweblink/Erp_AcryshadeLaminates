...
public partial class Packaging : System.Web.UI.Page
{
    ...
    private void FillGrid()
    {
        ...
        cmd.SelectCommand.Parameters.AddWithValue("@SP_Action", "GetCompletedWOList");
        cmd.SelectCommand.Parameters.AddWithValue("@MachineID", txtcompanyname.Text);
    ...
    {
        Response.Redirect("Packaging.aspx");
    }
